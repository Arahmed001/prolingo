    ...
    <div className="min-h-screen bg-muted py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          {/* Basic Plan */}
          <div className="bg-white p-8 rounded-xl shadow-md border border-border flex flex-col">
            <h3 className="text-xl font-semibold text-primary mb-2">Basic</h3>
            <div className="text-4xl font-bold text-primary mb-4">$9<span className="text-lg text-muted-foreground">/month</span></div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-primary flex flex-col relative">
            <div className="absolute top-0 right-0 bg-primary text-white text-xs font-bold px-3 py-1 transform translate-y-0 translate-x-0 rounded-bl-lg rounded-tr-lg">
              POPULAR
            </div>
            <h3 className="text-xl font-semibold text-primary mb-2">Pro</h3>
            <div className="text-4xl font-bold text-primary mb-4">$29<span className="text-lg text-muted-foreground">/month</span></div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-md border border-border flex flex-col">
            ...
            <div className="text-4xl font-bold text-primary mb-4">$99<span className="text-lg text-muted-foreground">/month</span></div>
