        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/testimonials" className="text-base text-muted-foreground hover:text-primary">
                  Testimonials
                </Link>
              </li>
              <li>
                <Link href="/integrations" className="text-base text-muted-foreground hover:text-primary">
                  Integrations
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link href="/blog" className="text-base text-muted-foreground hover:text-primary">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/guides" className="text-base text-muted-foreground hover:text-primary">
                  Teaching Guides
                </Link>
              </li>
              <li>
                <Link href="/webinars" className="text-base text-muted-foreground hover:text-primary">
                  Webinars
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/careers" className="text-base text-muted-foreground hover:text-primary">
                  Careers
                </Link>
              </li>
              <li>
