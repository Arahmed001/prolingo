      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white p-8 rounded-xl shadow-md">
          ...
          <div className="prose prose-sm max-w-none text-muted-foreground">
            <p className="mb-4">
              At ProLingo, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, 
              and safeguard your information when you use our platform.
            </p>
            
            <h2 className="text-xl font-semibold text-primary mt-6 mb-3">1. Information We Collect</h2>
            <p className="mb-4">
              We may collect personal information that you voluntarily provide when creating an account or using our services, 
              including but not limited to your name, email address, and learning preferences. We may also automatically 
            ...
            <p className="mb-4">
              ...
              except as described in this Privacy Policy. We may share information with trusted third parties who assist us 
              in operating our platform and serving our users.
            </p>
            ...
            <h2 className="text-xl font-semibold text-primary mt-6 mb-3">5. Cookies and Tracking Technologies</h2>
            <p className="mb-4">
              We use cookies and similar tracking technologies to track activity on our platform and hold certain information. 
              You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent.
            </p>
            
            <h2 className="text-xl font-semibold text-primary mt-6 mb-3">6. Children's Privacy</h2>
            <p className="mb-4">
            ...
            <h2 className="text-xl font-semibold text-primary mt-6 mb-3">7. Your Rights</h2>
            <p className="mb-4">
              Depending on your location, you may have certain rights regarding your personal information, including the right 
              to access, correct, delete, or restrict processing of your personal data. To exercise these rights, please contact us.
            </p>
            
            <h2 className="text-xl font-semibold text-primary mt-6 mb-3">8. Changes to This Privacy Policy</h2>
            <p className="mb-4">
              We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new 
              Privacy Policy on this page and updating the "Last updated" date.
            </p>
            
            <h2 className="text-xl font-semibold text-primary mt-6 mb-3">9. Contact Us</h2>
            <p className="mb-4">
              If you have any questions about this Privacy Policy, please contact us at privacy@prolingo.com.
            </p>
