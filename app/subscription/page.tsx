...
export default function SubscriptionPage() {
  ...
  if (!user) {
    return (
      <div id="main-content" className="min-h-screen flex items-center justify-center">
        <div id="main-content" className="text-xl font-medium text-primary">Redirecting to login...</div>
      </div>
    );
  }
    ...
    <div id="main-content" className="min-h-screen bg-muted py-12 px-4 sm:px-6 lg:px-8">
      <div id="main-content" className="max-w-4xl mx-auto">
        ...
        <div id="main-content" className="text-center mb-12">
          ...
          {updateSuccess && (
            <div id="main-content" className="mt-4 p-3 bg-green-100 text-green-700 rounded-md">
        ...
        {/* Subscription Plans */}
        <div id="main-content" className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {/* Free Plan */}
          <div id="main-content" className={`bg-white rounded-xl shadow-md overflow-hidden border-2 ${currentPlan === 'free' ? 'border-primary' : 'border-transparent'}`}>
            <div id="main-content" className="p-6">
              <h2 className="text-2xl font-bold text-primary mb-2">Free Plan</h2>
              <div id="main-content" className="text-3xl font-bold mb-4">$0<span className="text-lg text-muted-foreground font-normal">/month</span></div>
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center text-muted-foreground">
                  <svg aria-hidden="true" className="h-5 w-5 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button aria-label="Button" tabIndex={0}
                onClick={() => updateSubscription('free')} onKeyDown={(e) => { if(e.key === "Enter" || e.key === " ") e.currentTarget.click(); }}
          ...
          {/* Premium Plan */}
          <div id="main-content" className={`bg-white rounded-xl shadow-md overflow-hidden border-2 ${currentPlan === 'premium' ? 'border-primary' : 'border-transparent'}`}>
            <div id="main-content" className="p-6">
              <div id="main-content" className="bg-primary text-white text-center py-1 px-4 rounded-full text-sm font-medium w-fit mb-4">RECOMMENDED</div>
              <h2 className="text-2xl font-bold text-primary mb-2">Premium Plan</h2>
              <div id="main-content" className="text-3xl font-bold mb-4">$10<span className="text-lg text-muted-foreground font-normal">/month</span></div>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  ...
                  <span>Unlimited vocabulary practice</span>
                </li>
                <li className="flex items-center">
                  <svg aria-hidden="true" className="h-5 w-5 text-green-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>Basic grammar lessons</span>
                </li>
                <li className="flex items-center">
                  <svg aria-hidden="true" className="h-5 w-5 text-green-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <button aria-label="Button" tabIndex={0}
                onClick={() => updateSubscription('premium')} onKeyDown={(e) => { if(e.key === "Enter" || e.key === " ") e.currentTarget.click(); }}
        ...
        <div id="main-content" className="bg-white rounded-xl shadow-md overflow-hidden p-6 mb-8">
          <h2 className="text-2xl font-bold text-primary mb-4">ProLingo Coins</h2>
          <div id="main-content" className="flex flex-col md:flex-row md:items-center justify-between">
            <div id="main-content" className="mb-4 md:mb-0">
              ...
              <div id="main-content" className="mt-4 flex items-center">
                <div id="main-content" className="flex items-center bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full">
                  <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div id="main-content" className="flex flex-col space-y-2">
              <button aria-label="Button" tabIndex={0} className="bg-secondary text-white py-2 px-6 rounded-md hover:bg-secondary/90 transition-colors">
                Buy 100 Coins ($1)
              </button>
              <button aria-label="Button" tabIndex={0} className="bg-secondary text-white py-2 px-6 rounded-md hover:bg-secondary/90 transition-colors">
                Buy 500 Coins ($5)
